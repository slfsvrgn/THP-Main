			...
			<div class="st-content"><!-- this is the wrapper for the content -->
				<div class="st-content-inner entry-content"><!-- extra div for emulating position:fixed of the menu -->
					...
					<div class="hidden-xs hidden-sm po-port-nav navigation-big-image">
						<a href="alpha-male.php" rel="next">
							<div class="arrow-next"></div>
							<h2 class="titlea">Alpha Male</h2></a>

						<div class="banner2"></div>
						<div class="next-b"></div>

						<a href="rush-hour.php" rel="prev">
							<div class="arrow"></div>
							<h2 class="titleb">Rush Hour</h2></a>
					...
					<div class="row po-full-width">
						<div class="portfolio-page col-sm-12 column-12 white-content">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <div class="love green">
                                                            <div class="love-it-wrapper"><a href="#" class="love-it" data-post-id="273" data-user-id="0"><i class="fa fa-heart-o"></i></a> <span class="love-count">17</span></div>                        </div>
                                                    </li>
                                                </ul>
                                            </div>
							...
							<div class="portfolio-info-top-standard">
								<div class="slider-image-inner-portfolio">
                                    <div class="po-column slider-caption-portfolio margin padding" data-delay="1700" data-animation="move-up-short">
										<h1 class="standard-header-portfolio">Hanging Camera</h1>
											...
											<a href="alpha-male.php" rel="next">
												<div class="nav-portfolio-item nav-portfolio-item-2"
													...
													<div class="next-portfolio-item"><h5
															class="next-portfolio-item-text-2">Alpha Male</h5></div>
												</div>
											</a>
											...
											<a href="rush-hour.php" rel="prev">
												<div class="nav-portfolio-item nav-portfolio-item-2 mleft20">
													<div class="prev-portfolio-item"><h5
															class="prev-portfolio-item-text-2">Rush Hour</h5></div>
							...
							<div class="liquid-container-page">
								<a href="portfolio.php"><img width="1300" height="800" src="images/1300-800.png"
								                             class=" wp-post-image"
								                             alt="camera_mini"/></a>
					...
					<div class="arrow-container">
						<div class="arrow-container-inner">
							<div class="transparent-triangle-container">
								<table >
									<tr>
										<td class="transparent-triangle-left-white background-white"></td>
										<td class="transparent-triangle-left-triangle-container">
											<div class="transparent-triangle-left-triangle white-backgroud-border-left"></div>
										</td>
										<td class="transparent-triangle-right-triangle-container">
											<div class="transparent-triangle-right-triangle white-backgroud-border-right"></div>
										</td>
										<td class="transparent-triangle-right-white background-white"></td>
									</tr>
								</table>
					...
					<div class="entry-content">
							...
							<div class="container">
								<div class="row">
									...
									<div class="po-column col-sm-4 col-sm-offset-0 paddingTop"
										...
										<div class="clearfix"></div>
										<p class="textblock textblock-left">
											Photograph by <a title="Christian Bardenhorst"
											                 href="#" target="_blank">Little
												Visuals</a>.</p>

										<p>Donec nunc massa, dictum a porttitor sit amet, aliquam et mi. Pellentesque
											adipiscing convallis lacus eget scelerisque. Fusce rhoncus libero sed mi
											ultrices, vitae tempus arcu auctor. </p>
									</div>
									<div class="po-column col-sm-4 col-sm-offset-0 paddingTop"
									      data-animation="fade-in">
										<div class="padding po-column po-header-top col-sm-12" data-delay="0" 										     data-animation="fade-in"><h3
										...
										<div class="parent">
											<div class="row">
												<div class="col-xs-10"><i class="fa li_bulb"
												                         ></i>
													<h6 class="progress-title">
														Strategy</h6>
											...
											<div class="progress">
												<div class="progress-bar" role="progressbar"  data-progress="40"></div>
											</div>
										</div>
										<div class="parent">
											<div class="row">
											...
											<div class="progress">
												<div class="progress-bar" role="progressbar"  data-progress="10"></div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="po-section section-background-light"
							...
							<div class="container">
								<div class="row">
									<div class="po-column po-header-top col-sm-12 padding" data-delay="0"
									     data-animation="fade-in"><h3
											class="text-center standard-header"
											>
									...
									<div class="po-column col-sm-4 col-sm-offset-0"
									      ...
									      data-animation="fade-in">
										<div class="po-column col-sm-12 portfolio-item-effect padding" data-delay="0"
										     data-animation="fade-in" >
											<div class="grid cs-style-3 media-container height_hanging">
                                                <a class="view" href="#">
													<figure>
                                                        <img class="img-responsive" src="images/500-333.png" alt=""/>
														<figcaption class="height_hanging"></figcaption>
													</figure>
												</a></div>
										</div>
										<div class="clearfix"></div>
										<div class="po-column po-header-top col-sm-12 padding" data-delay="0"
										     data-animation="fade-in">
											<div class="header-small-padding padding30"><h3 class="header-small">
													The Process </h3></div>
										</div>
										<div class="clearfix"></div>
										<p class="textblock textblock-left">
											Vestibulum ac pretium nisi. Suspendisse ut nunc massa. Nunc tincidunt
											suscipit tellus pharetra posuere. Mauris odio ante, vulputate ut posuere ut,
											tincidunt sit amet turpis. Aliquam elementum metus non enim accumsan, in
											lacinia mauris auctor. </p>
									</div>
									<div class="po-column col-sm-4 col-sm-offset-0"

									     data-delay="400" data-animation="fade-in">
										<div class="po-column col-sm-12 portfolio-item-effect padding" data-delay="0"
										     data-animation="fade-in">
											<div class="grid cs-style-3 media-container height_hanging"><a
													class="view"
													href="#"
													>
													<figure><img class="img-responsive"
													             src="images/500-333.png"
													             alt=""/>
														<figcaption class="height_hanging"></figcaption>
													</figure>
												</a></div>
									...
									<div class="po-column col-sm-4 col-sm-offset-0"
									     ...
									     data-delay="800" data-animation="fade-in">
										<div class="po-column col-sm-12 portfolio-item-effect  padding" data-delay="0"
										     data-animation="fade-in">
											<div class="grid cs-style-3 media-container height_hanging"><a
													class="view"
						...
						<div id="numbers" class="po-section section-image section-background-image-parallax hanging_fig_"
						     data-center="background-position: 50% 0px;"
						     data-bottom-top="background-position: 50% 150px;"
						     data-top-bottom="background-position: 50% -150px;"
						     data-anchor-target="#numbers"><!--[if IE 8]><img class="section-bg-ie"
						                                                      src="images/1300-867.png"
