			...
			<div class="st-content"><!-- this is the wrapper for the content -->
				<div class="st-content-inner entry-content"><!-- extra div for emulating position:fixed of the menu -->
					...
					<div class="hidden-xs hidden-sm po-port-nav navigation-big-image">
						<a href="raging-buffalo.php" rel="next">
							<div class="arrow-next"></div>
							<h2 class="titlea">Raging Buffalo</h2></a>

						<div class="banner2"></div>
						<div class="next-b"></div>

						<a href="the-high-life.php" rel="prev">
							<div class="arrow"></div>
							<h2 class="titleb">The High Life</h2></a>
										...
										<div class="col-sm-6 col-sm-offset-6 text-right share-port-ie white-content">
                                            <div class="share-links-standard">
                                                <ul>
                                                    ...
                                                    <li><a href="#" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><span class="index goog"><i class="fa fa-google-plus"></i></span></a></li>
                                                    <li><a href="#" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=260,width=600');return false;"><span class="index twit"><i class="fa fa-twitter"></i></span></a></li>
                                                    <li><a href="#" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=220,width=600');return false;"><span class="index fb"><i class="fa fa-facebook"></i></span></a></li>
                                                    <li>
                                                        <div class="love green">
                                                            <div class="love-it-wrapper"><a href="#" class="love-it" data-post-id="298" data-user-id="0"><i class="fa fa-heart-o"></i></a> <span class="love-count">3</span></div>                        </div>
                                                    </li>
                                                </ul>
                                            </div>
							...
							<div class="portfolio-info-top-standard">
								<div class="slider-image-inner-portfolio">
                                    <div class="po-column slider-caption-portfolio margin padding" data-delay="1700" data-animation="move-up-short">
										<h1 class="standard-header-portfolio">Tramp</h1>
											...
											<a href="raging-buffalo.php" rel="next">
												<div class="nav-portfolio-item nav-portfolio-item-2"
													...
													<div class="next-portfolio-item"><h5
															class="next-portfolio-item-text-2">Raging Buffalo</h5></div>
												</div>
											</a>
											...
											<a href="the-high-life.php" rel="prev">
												<div class="nav-portfolio-item nav-portfolio-item-2 mleft20">
													...
													<div class="prev-portfolio-item"><h5
															class="prev-portfolio-item-text-2">The High Life</h5></div>
					...
					<div class="entry-content">
						<div class="po-section section-background-light"
							...
							<div class="container">
								<div class="row">
									<div class="po-column col-sm-4 col-sm-offset-0 paddingTop" data-animation="fade-in">
					...
					<div class="section-background-white padding_related">
						...
						<div class="portfolio-item-effect-2">
							<div class="grid">
								<a class="po-column col-sm-4 port-cont no-padding-port" href="rush-hour.php"
								   data-delay="0" data-animation="fade-in-port" >
